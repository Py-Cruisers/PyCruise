...
- Custom Desktop Application
    - Docs: Medium (Build your first Desktop App)
        - [Medium (Desktop App)](https://medium.com/analytics-vidhya/how-to-build-your-first-desktop-application-in-python-7568c7d74311)
    - Create our own custom Desktop Application
        - Build basic UI and functionality to get a custom desktop application off the ground!
    - Potential Features
        - Military memorandum automation (combine into various file features)
    - File Sorting
        - Sort screenshots from desktop into organized files
        - Overhaul filesystem org???
    - Automatically open Zoom when class starts in the morning :)
    - Open dev workflow
        - Chrome
        - Gmail
        - Canvas
        ...
        - Ubuntu CLI
        - PyCharm/VS Code
- Backup MVP: Any of the above as the sole objective (scaled according to complexity)
<hr>
...
- Name of Project
    - PyCruise: The desktop app that automates menial desktop tasks and operations .
- What problem or pain point does it solve? 
    - Tedious tasks like formatting memorandums and clicking through the desktop to get your dev workflow environment set up are such a drag! 
    - Save time and automate the processes that waste your precious focus and energy by optimizing your desktop workflow with python automation!
- Minimum Viable Product (MVP) definition.
- What is the minimum required for you to present on your demo day?
    - A custom desktop application that opens with (or potentially even without) user input and successfully carries out operations like opening desktop application with a single click or typed command, automatically organizing downloaded files, and producing pre-formatted memorandum templates.
